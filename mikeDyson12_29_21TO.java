...
@TeleOp(name = "mikeDyson12_29_21TO")
public class mikeDyson12_29_21TO extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.update();
         ...
         while (opModeIsActive()) {
            ...
            //pressing y for driver slows down Mike Dyson
            if (gamepad1.y) {
                ...
                p3 /= max;
                p4 /= max;
                backLeft.setPower(p1 * 0.3);
                frontLeft.setPower(p2 * 0.3);
                frontRight.setPower(p3 * 0.3);
                backRight.setPower(p4 * 0.3);
